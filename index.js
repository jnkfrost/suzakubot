...
const adminGroupModule = require('./handlers/adminGroup');
const handleAdminGroup = adminGroupModule.handleAdminGroup;
...
client.on('message', async (message) => {
    try {
        ...
        const adminHandled = await handleAdminGroup(message, chat, client);
        ...
        // 5. Easter eggs
        const easterEggHandled = await handleEasterEggs(message, chat);
